...
export default function Begining() {
    return (
        <div className='relative h-screen w-full bg-white overflow-hidden'>
            ...
            <div className="bottom-[-100px] hd:bottom-[-200px] left-1/2 -translate-x-1/2 w-[500px] z-0 opacity-90 relative">
                <Image
                ...
                <div className="absolute bottom-0 left-0 w-full sm:h-[550px] h-[450px] bg-gradient-to-t from-white/95 to-transparent pointer-events-none" />
            </div>
            ...
            <div className='absolute bottom-0 w-full p-9 z-10 flex flex-col items-center justify-center'>
                ...
                <motion.h1
                    ...
                    className="cursor-pointer bg-sky-400 p-2 sm:text-9xl text-6xl font-bold m-3 bg-gradient-to-r from-[#123466] via-blue-600 to-blue-400 text-transparent bg-clip-text"
                >
                    Ürünlerimiz
                </motion.h1>
