        ...
        <div className="w-full h-full p-4 pt-[10lvh] justify-center flex">
            <div className="w-full h-full flex md:flex-row flex-col md:w-2/3">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="w-full max-h-max flex flex-col border border-[#123466] rounded-tl-2xl md:rounded-bl-2xl md:rounded-tr-none rounded-tr-2xl px-6 py-8">
                ...
                <div className="md:w-[35vw] w-full md:max-h-max flex flex-col border border-[#123466] bg-[#123466] md:rounded-tr-2xl md:rounded-bl-none rounded-bl-2xl rounded-br-2xl justify-around py-2">
