        ...
        <footer className="text-white h-auto px-2 py-4 flex flex-col items-center justify-between bg-[#0A0046] xl:gap-3 gap-1 rounded-tr-xl rounded-tl-xl xl:rounded-none">
            ...
            <div className='xl:w-[80%] w-full flex xl:flex-row flex-col justify-between self-center items-center'>
                ...
                <div className='w-full h-full'>
                    <ul className='sm:flex flex flex-wrap gap-6 xl:text-lg justify-center items-center'>
                        {navItems.map((item) => {
                            return (
                                <Link
                                    key={item.href}
                ...
                <div className='p-3'>
                    <ul className='gap-3 flex justify-center xl:text-3xl text-2xl'>
                    ...
                    <p className='mt-3 cursor-pointer text-xs hover:text-yellow-300 transition duration-300'>destek@regeditpos.com</p>
                </div>
